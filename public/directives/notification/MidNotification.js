angular.module("DirectiveModule")
  ...
  .directive("midNotification", ["$rootScope", function ($rootScope) {
	"use strict";
	...
	return {
      ...
      '<div class="growl">' +
		...
		replace: false,
		scope: true,
		controller: ['$scope', '$timeout', 'NotificationManager', function ($scope, $timeout, NotificationManager) {
			var onlyUnique = NotificationManager.onlyUnique();
